...
public class cadastroDAO {
    ...
    public void create(cadastro c){
        ...
        try{
            ...
            stmt = con.prepareStatement("INSERT INTO cadastro (descricaoProduto, precoProduto, codigoProduto, idCor, idMarca) VALUES (?,?,?,?,?)");
            
            stmt.setString(1,c.getDescricaoProduto());
            stmt.setDouble(2,c.getPrecoProduto());
            stmt.setInt(3,c.getCodigoProduto());
            stmt.setInt(4,c.getIdCor());
            stmt.setInt(5,c.getIdMarca());
